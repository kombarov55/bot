...
stages = [
    {
        "id": u"Первое сообщение",
        "text": u"Здравствуй, путник! Зачем ты пришёл к нам?",
        "options": [
            { "text": u"Получить предсказание", "nextId": u"Подтверждение предсказания"},
            { "text": u"Хочу задать вопрос", "nextId": u"Вопрос" },
            { "text": u"Ничего, просто смотрю", "nextId": u"Прощание" }
        ]
    },
    {
        "id": u"Подтверждение предсказания",
        "text": u"Отлично. Ты готов к тому чтобы узнать о завтрашнем дне?",
        "options": [
            { "text": u"Глаголь ;)", "nextId": u"Предсказание" },
            { "text": u"Нет, спасибо.", "nextId": u"Прощание" },
            { "text": u"Ещё чего. Я сам творю свою судьбу.", "nextId": u"Прощание" }
        ]
        
    },
    {
        "id": u"Предсказание",
        "text": u"Отлично. Это твой выбор. А теперь скажи, чего тебе хочется!",
        "options": [
            { "text": u"Пожалуйста, скажи как пройдёт сегодняшний день", "nextId": u"Результат предсказания" },
            { "text": u"Хочу чтобы ты отсылал мне предсказания каждый день в 9 утра", "nextId": u"Рассылка" }
        ]
    },
    {
        "id": u"Результат предсказания"
    },
    {
        "id": u"Рассылка"
    },
    {
        "id": u"Прощание",
        "text": u"Чтож, это твой выбор. Удачи на твоём пути! Если передумаешь - скажи ;)",
        "options": [
            { "text": u"Прости, я поспешил. Впрочем, предсказание на сегодня мне бы не помешало. ", "nextId": u"Предсказание" }
        ]
    } 
]
